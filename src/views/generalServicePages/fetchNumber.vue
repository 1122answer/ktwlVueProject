            ...
            <v-more-panel>
                 <v-form slot="form">
                     <v-form-item label="选择系统">
                         <v-select placeholder="请选择系统" :data="getsystemSelect" v-model="searchSystemId" style="width:150px"></v-select>
                     </v-form-item>
                     <v-form-item label="行政区域">
                         <v-tree-select :data="getRegionSelect" v-model="searchRegionCode" style="width:150px" :allowClear="true" @select="regionchange" @clear="clearregion" :optionOnChange="true"></v-tree-select>
                     </v-form-item>
                     <v-form-item label="规则编号">
                         <v-input placeholder="请输入规则编号" :style="{width:'100%'}" v-model="searchRuleCode"></v-input>
                     </v-form-item>
                     <v-form-item label="规则名称">
                          <v-input placeholder="请输入规则名称" :style="{width:'100%'}" v-model="searchRuleName"></v-input>
                     </v-form-item>
                 </v-form>
                  ...
                  <v-button type="primary" size="large" class="pull-right" @click="addTnRule" style="margin-top:2px;">
                    ...
                    <v-data-table :data='loadData' :responseParamsName="responseParamsName" :columns='columns' size="small" class="margin-top-15" bordered ref="tnTable" emptyText="暂时找不到你要的信息......">
