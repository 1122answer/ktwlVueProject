<template>
    <div id="validateSmsLog" class="moduleWrap">
        <validateSmsLogDetails :visible="visible" @cancel="handleCancel"> </validateSmsLogDetails>
        ...
        <div class="box-border" ref="boxBorder">
            ...
            <div class="container-fluid" ref="containerFluid">
                 <v-data-table :data='loadData' :responseParamsName="responseParamsName" :columns='columns' size="small" bordered ref="smsLogTable" emptyText="暂时找不到你要的信息......" :height='tableBoxHeight'>
                   <template slot="td" slot-scope="props" >
                       <div v-if="props.column.field=='vstatus'" class="text-left" style="width:200px;">
...
export default {
    ...
    data: () => ({
        ...
        loadData(params) {
            return this.$store .dispatch("vcodeSmsLogModule/getPageList", {
    ...
    methods: {
        ...
        smsLogDetails(event) {
            this.visible = true;
            return this.$store.dispatch("vcodeSmsLogModule/getDetails", event);
        }
    }
};
</script>
