<template>
    <div id="addEditBuild">
        <v-modal title="添加栋信息" :visible="isBuild" @ok="handleAsyncOk" @cancel="handleAsyncCancel" :confirm-loading="asyncConfirmLoading" :width="mdlwidth" wrapClassName="wrapOuter" ref="mdl" :tog-full="togFlag">
