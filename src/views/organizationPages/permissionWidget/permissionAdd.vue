<template>
    <v-modal :title="titlename" :visible="visible" :confirmLoading="loading" :width="900" @ok="handleOk" @cancel="handleCancel" :maskClosable="false">
        <premissionList :visible="permisstion" @ok="addOk" @cancel="addCancel"></premissionList>
            ...
            <div style="border-top:1px solid #f2f2f2;">
                ...
                <v-row>
                    <v-col span="24" class="text-center">
                        <v-button type="primary" class="pull-right" size="large" @click="addDiag">
